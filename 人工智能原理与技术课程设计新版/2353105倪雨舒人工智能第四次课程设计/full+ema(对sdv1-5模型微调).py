...
def parse_args():
    ...
    parser.add_argument(
        "--train_text_encoder",
        action="store_true",
        help="Whether or not to fine-tune the text encoder during training.",
    )
    parser.add_argument(
        "--train_vae",
        action="store_true",
        help="Whether or not to fine-tune the VAE during training.",
    )
...
def main():
    ...
    # unet.train()
    # Conditionally freeze or unfreeze models
...
#             try:
#             # 尝试访问图像张量，触发潜在损坏图像的异常
#                 _ = example["pixel_values"].shape
#                 valid_examples.append(example)
#             except Exception as e:
#                 import logging
#                 logging.warning(f"跳过损坏图片：{e}")
#         if not valid_examples:
#             return None  # 空 batch，跳过
